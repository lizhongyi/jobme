...
<h3 class="title-big"><i class="icon-user"></i> 普通用户升级为高级用户</h3>
</div>
<h3>高级用户</h3>
<p style="padding-left:20px;">高级用户收费标准为100元/年，您可以通过以下方式进行支付，支付成功，即升级为高级用户。</p>
...
<form name=alipayment action=/alipay/alipayapi.php method=post target="_blank">
            <div id="body" style="clear:left; display:none">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input value="高级用户申请" size="30" name="WIDsubject" />
                        <span>必填
</span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30"  value="0.1" name="WIDprice" />
                        <span>必填
</span>
                    </dd>
                    <dt>订单描述
：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" value="升级为高级用户" name="WIDbody" />
                        <span></span>
                    </dd>
                    <dt>商品展示地址：</dt>
                    <dd>
            ...
            <span class="new-btn-login-sp">
                            <button class="btn new-btn-login btn-large btn-primary" type="submit" style="text-align:center;">确认升级</button>
                        </span>
	  </form>
</div>
