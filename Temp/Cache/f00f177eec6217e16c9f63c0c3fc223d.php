...
<input type="text" name="area_cn"  id="area_cn" class="se-input area" style="width:150px;"  value="<?php echo ($_GET['area_cn']); ?>" />
<input type="hidden" name="area" id="area-val" value="<?php echo ($_GET['area']); ?>"/>
</li>

<li>           <span class="label">行业</span>

<input type="text" name="trade_cn" id="industry_input" style="width:150px;"  class="se-input span2 industry"  value="<?php echo ($_GET['trade_cn']); ?>" />
...
<input type="text" style="width:20px; float:left; border:0px; " value="至" /><input  type="text" class="span1" style="width:50px; float:left;" name="payment1" id="payment1" value="<?php echo ($_GET['payment1']); ?>"><span style="width:50px; text-align:center; line-height:30px; float:left">万元</span><div style="clear:both; height:10px;"></div>
</li>
<li>           <span class="label">关键字</span>

<input type="text" name="keyword" id="keyword" class="se-input" style="width:150px;" value="<?php echo ($_GET['keyword']); ?>" /></li>
