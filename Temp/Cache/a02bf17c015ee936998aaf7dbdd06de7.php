...
<div class="lt" style="box-shadow:none1">
<div class="" style="border-bottom:1px solid #ddd; padding-bottom:10px;">

<h3 class="title-big"><?php echo ($dt['companyname']); ?></h3>

</div>
<div class="" style="border-bottom:0px solid #ddd; padding-bottom:10px; margin-top:20px;">

<div class="job_detail" style="margin-top:-20px;">


<ul>
<li><div class="com_logo"><img src="<?php echo (company_logo($dt['logo_file'])); ?>" /></div></li>
<div class="cl"></div>
<li><span class="label">企业性质：</span>  <?php echo ($select['nature'][$dt['nature']]); ?></li>
<li><span class="label">企业规模：</span> <?php echo ($select['scale'][$dt['scale']]); ?></li>
<li><span class="label">所属行业：</span><?php echo ($dt['trade_cn']); ?></li>
<li>
<span class="label">所在地区：</span><?php echo ($dt['area_cn']); ?></li>

<li>
<span class="label">注册资金：</span><?php echo ($dt['registered']); ?></li>

<li>
<span class="label">　联系人：</span><?php echo ($dt['linkman']); ?></li>

<li>
<span class="label">联系电话：</span><?php echo ($dt['tel']); ?></li>

<li>
<span class="label">通信地址：</span><?php echo ($dt['addr']); ?></li>


<li><span class="label"><strong>公司简介</strong></span></li>
<div class="cl"></div>
<li style="width:620px;">
<?php echo ($dt['about']); ?></li>
<div class="cl"></div>
</ul>
...
<div class="cl"></div>
<div class="" style="border-bottom:1px solid #ddd; padding-bottom:10px;">
<h3 class="title-big">公司旗下猎头</h3>
</div>
<div class="hunter_list">
  
  <ul>
  <?php if(is_array($hlist)): $i = 0; $__LIST__ = $hlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="border:0px; height:180px; margin-right:12px"><a href="/Hunter/detail/id/<?php echo ($vo['uid']); ?>"><img src="<?php echo (get_ht_face($vo['uid'])); ?>" width="140" height="120"  style="border:1px solid #ddd;" /></a>
  <div class="uname"><a href="/Hunter/detail/id/<?php echo ($vo['uid']); ?>"><?php echo ($vo['username']); ?></a></div>
  <div ><?php echo ($vo['jcont']); ?>个职位</div>
...
<div class="search">
<form name="se" id="se" method="get" action="/Company">
<ul>
     
      <li>           <span class="label">地区</span> <input type="text" name="area_cn"  id="area_cn" class="se-input area"  value="<?php echo ($_GET['area_cn']); ?>" />
