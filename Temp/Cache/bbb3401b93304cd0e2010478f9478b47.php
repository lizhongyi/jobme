...
<h3 class="title-big">猎头公司</h3>

</div>
<div class="" style="border-bottom:1px solid #ddd; padding-bottom:10px; margin-top:20px;">

<?php if(isset($getList)): ?><ul class="company_ul">
<?php if(is_array($getList)): $i = 0; $__LIST__ = $getList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li> <a href="/Company/detail/id/<?php echo ($vo['uid']); ?>" class="ta"><img id="faceimg" src="<?php echo (company_logo($vo['logo_file'])); ?>" style="border:1px solid #ddd"></a>
<div class="c-title"><a href="/Company/detail/id/<?php echo ($vo['uid']); ?>"><?php echo ($vo['companyname']); ?></a><br>

<?php if($vo['job_totals'] > 0): ?><a href="/Company/company_job/id/<?php echo ($vo['uid']); ?>" style="color:#069"> <?php echo ($vo['job_totals']); ?>个职位</a><?php endif; ?></div></li><?php endforeach; endif; else: echo "" ;endif; ?>
<div class="cl"></div>
...
$("#company_ul li a img").each(function(index, element) {
