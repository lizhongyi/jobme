...
<div class="lt">
<div class="" style="border-bottom:0px solid #ddd; padding-bottom:0px;">

<h3 class="title-big">猎头资料</h3>
...
<img src="<?php echo (get_ht_face($dt['uid'])); ?>" width="130" height="140" style=" border:1px solid #ddd" />
</div>


<div class="infobox">
<div class="job_detail" style="margin-top:-18px;">


<ul class="hunter_ul" style="line-height:28px;">
<li><span class="label">猎头姓名：</span><?php echo (gettruename($dt['uid'])); ?></li>
<li> <span class="label">所在地区：</span><?php echo ($dt['area_cn']); ?></li>
<li> <span class="label">所在公司：</span><a title="<?php echo ($dt['company']); ?>" href="/Company/detail/id/<?php echo ($dt['comid']); ?>"><?php echo (msubstr($dt['company'],0,16)); ?></a></li>

<li> <span class="label">发布职位：</span><?php echo ($dt['zhiwei_num']); ?> 个猎头职位</li>
<li> <span class="label">电子邮箱：</span><?php echo ($dt['email']); ?> </li>
<li> <span class="label">移动电话：</span><?php echo ($dt['phone']); ?> </li>


<li><button href="#msgbox" data-toggle="modal" class="sms-add  btn btn-info" uid="<?php echo ($dt['uid']); ?>">咨询猎头</button></li>
...
<div class="" style="border-bottom:1px solid #ddd; padding-bottom:10px; margin-top:20px;">

<h3 class="title-big">TA发布的职位</h3>
...
<td width="21%"><?php echo ($vo["area_cn"]); ?></td>
<td width="14%"><?php echo (date('Y-m-d',$vo["create_time"])); ?></td>
<td width="24%"><span class="pay"><?php echo ($vo["payment"]); ?><span style="font-family:'宋体'"> -</span> <?php echo ($vo["payment1"]); ?>万元</span></td>
<td width="13%">
<?php if($vo['sed'] == 0): ?><a  href="javascript:;" link="/Save/add" gid="<?php echo ($vo['id']); ?>" jobname="<?php echo ($vo['Search_posts']); ?>" class="btn apply_saved" >收藏</a>
