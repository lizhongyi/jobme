...
var loadGif = "<img src='/images/load.gif' class='loadbig' align='center' />";
var ajax = 0;
...
function showname($obj,id){
	...
	function showResutl($str,$st,fun){
		           ...
		           $("body").append("<div id='result'><div>");
					...
					//$("<h4>成功</h4>").appendTo("#result");	  
						  
				   $("<div>"+$str+"</div>").appendTo("#result");
				   $("#result").fadeIn();
...
function ajaxfun($url,$tdata,$this,fun){
			 ...
			 $.ajax({
					...
					success:function(data){ 
					        ...
					        if(data.status==1){
								...
								showResutl(data.info,1,fun);
								
								
								}else{
									
									showResutl(data.info,0);
