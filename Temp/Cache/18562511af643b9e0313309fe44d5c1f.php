...
<div class="tab">  <a  class="tab-bar hover" href="/User/index" style="padding:1px 10px;">用户中心</a> <a  class="tab-bar " href="/User/apply" style="padding:1px 10px;">应聘的职位</a>  <a  class="tab-bar" href="/User/saved" style="padding:1px 10px;">收藏的职位</a><a  class="tab-bar" href="/User/profile_edit" style="padding:1px 10px;">我的资料</a> <a href="/Resume" class="tab-bar" style="padding:1px 10px;">我的简历</a> <div class="cl"></div> </div>
 ...
 <ul class="inform_ul">
  <li><h4>职位申请通知</h4></li>
<?php if(is_array($infoList)): $i = 0; $__LIST__ = $infoList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo['rd'] == 0): ?>style=" background:rgb(231,241,249)"<?php endif; ?>>
